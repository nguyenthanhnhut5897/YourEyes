...
class PulsatingButton: UIButton {
    let pulseLayer: CAShapeLayer = {
        ...
        shape.lineWidth = 10
        shape.fillColor = UIColor.YourEyes.linkColor.withAlphaComponent(0.3).cgColor
        shape.lineCap = .round
        return shape
    }()
    ...
    fileprivate func setupShapes() {
        ...
        backgroundLayer.fillColor = UIColor.white.withAlphaComponent(0.1).cgColor
